# This code is adopted from LLaVA: https://github.com/haotian-liu/LLaVA. Please follow the origin License.
...
class LlavaLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        if vision_tower is not None and (input_ids.shape[1] != 1 or self.training) and images is not None:
            ...
            if type(images) is list: #===self.mm_projector 把图像特征再投影一下.
